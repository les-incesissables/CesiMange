...
const Home: React.FC = () =>
{
    const {
        ...
        getNextPageParam: (lastPage) => lastPage.data[1].hasNext ? lastPage.data[1].currentPage + 1 : null,
        initialPageParam: 1,
    });
    ...
    const currentPage = data?.pages[data.pages.length - 1].data[1].currentPage || 1;

...
// Nous utilisons l'objet restaurantIds défini plus tôt
const orders = [
  {
    ...
    items: [
      {
        menu_item_id: menuIds[0], // Menu du Bistrot
        name: "Escargots de Bourgogne",
        price: 12.50,
        quantity: 1,
  ...
  },
  {
    ...
    items: [
      {
        menu_item_id: menuIds[1], // Menu Dégustation
        name: "Edamame",
        price: 4.90,
        quantity: 2,
        special_instructions: ""
  ...
  },
  {
    ...
    items: [
      {
        menu_item_id: menuIds[2], // Menu Pizzeria
        name: "Pizza Margherita",
        price: 10.90,
        quantity: 1,
...
print("🎉 Toutes les données d'exemple ont été ajoutées avec succès à la base de données CesiMange !")